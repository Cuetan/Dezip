...
export default function Questions() {
  ...
  const themes = [...new Set(QUESTIONS.filter(q => q.level === level).map(q => q.theme))]
            ...
            return (
              <div
                ...
                style={{
                  ...
                  border: isAnswered ? '1.5px solid var(--border)' : '1.5px solid var(--border)',
                  borderRadius: 20,
                  padding: '22px 24px',
